...
function TiersCard(props) {
	...
	return (0, import_react.createElement)("div", { style: CARD_STYLE }, (0, import_react.createElement)("label", { style: LABEL_STYLE }, t("title")), (0, import_react.createElement)("p", { style: HINT_STYLE }, t("description")), (0, import_react.createElement)("textarea", {
		value: draft,
		rows: 14,
		spellCheck: false,
	...
	}), (0, import_react.createElement)("div", { style: ROW_STYLE }, (0, import_react.createElement)("button", {
		style: BUTTON_STYLE,
		onClick: () => {
			save();
		}
	}, t("save")), (0, import_react.createElement)("button", {
		style: BUTTON_STYLE,
		onClick: reload
	}, t("reload")), (0, import_react.createElement)("button", {
		style: BUTTON_STYLE,
		onClick: () => {
			reset();
		}
	}, t("resetToComposition"))), status === "" ? null : (0, import_react.createElement)("div", { style: STATUS_STYLE }, status));
}
const CARD_STYLE = {
	display: "flex",
...
function apply(ctx) {
	ctx.effect(() => ctx.locale.register(NS, {
		zh,
		en
	}), "routed-subagent: card dictionaries");
	...
	ctx.inject(["settingsScope"], (scoped) => {
		...
		scoped.slots.inject("settings.plugin.item", () => scoped.slots.register({
			...
			locale: NS,
			inject: () => ({ t })
		}, () => (0, import_react.createElement)(TiersCard, {
			t,
			scope
		})));
	});
